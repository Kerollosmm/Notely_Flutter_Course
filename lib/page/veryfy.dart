...
class EmailVerificationDialog extends StatefulWidget {
  ...
  const EmailVerificationDialog({Key? key, this.Email}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'We just sent an email to ${widget.Email ?? "your email address"}.\nClick the link in the email to verify your account.',
            ...
            ElevatedButton(
              ...
              onPressed: () {
                // Manually trigger a check for email verification
                context.read<AuthBloc>().add(const AuthEventsInitialize());
              },
              child: const Text(
